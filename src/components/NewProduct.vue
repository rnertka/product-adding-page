      ...
      <div class="card offset-2 col-md-3">
        <div class="card-body tex-center d-flex align-items-center flex-column">
          <img height="128" class="img-responsive text-center mb-3"
               :src="product.selectedImage == null ? 'https://labdanismanlik.com/wp-content/plugins/ecommerce-product-catalog/img/no-default-thumbnail.png' : product.selectedImage ">
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="form-group col-md-6">
                ...
                <input type="text" v-model="product.count" class="form-control" placeholder="enter number">
              </div>
              <div class="form-group col-md-6">
...
export default { 
    ...
    methods: {
      ...
      addProduct(){
          ...
          this.Bus.emit('productAdded', this.product);
          this.product = {
            title : null,
            count : null,
            price : null,
